...
Elm.Trixel.Constants.make = function (_elm) {
   ...
   var keyCodeCtrl = 17;
   var keyCodeShift = 16;
   var shortcutMinus = 189;
   var shortcutEqual = 187;
   ...
   var workspaceOffsetMouseMoveSpeed = 2;
   ...
   _elm.Trixel.Constants.values = {_op: _op
                                  ...
                                  ,workspaceOffsetMouseMoveSpeed: workspaceOffsetMouseMoveSpeed
                                  ,sqrt3: sqrt3
                                  ...
                                  ,shortcutY: shortcutY
                                  ,shortcutZ: shortcutZ
                                  ,shortcutEqual: shortcutEqual
                                  ,shortcutMinus: shortcutMinus
                                  ,keyCodeShift: keyCodeShift
                                  ,keyCodeCtrl: keyCodeCtrl
                                  ,keyCodeSpace: keyCodeSpace
...
Elm.Trixel.Main.make = function (_elm) {
   ...
   $Trixel$Types$JSGlue = Elm.Trixel.Types.JSGlue.make(_elm),
   ...
   var view = function (state) {
      ...
      _U.eq(state.windowDimensions.x,
      0) ? _L.fromArray([A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([]))]) : _L.fromArray([$Trixel$Zones$Menu.view(state)
   ...
   countY) {
      return function () {
         var freshTimeState = A2($Trixel$Types$General.constructFreshTimeState,
         countX,
         countY);
         return {_: {}
                ,actions: {_: {}
                ...
                ,glueState: $Trixel$Types$JSGlue.emptyGlueState
   ...
   var triggerJSInput = Elm.Native.Port.make(_elm).inboundSignal("triggerJSInput",
   "Bool",
   function (v) {
      return typeof v === "boolean" ? v : _U.badPort("a boolean (true or false)",
      v);
   });
   var triggerJSInputSignal = A2($Signal.map,
   function (active) {
      return active ? $Trixel$PostOffice.EnteringHTMLInput : $Trixel$PostOffice.LeavingHTMLInput;
   },
   triggerJSInput);
   var workspaceSignals = A2($Signal.foldp,
   $Trixel$PostOffice.workspacePostOffice,
   $Trixel$Types$General.SwitchAction({_: {}
                                      ,action: $Trixel$Types$General.None
                                      ,condition: $Trixel$Types$General.NormalCondition
                                      ,inputsActive: 0}))($Signal.mergeMany(_L.fromArray([$Trixel$PostOffice.postOfficeQuery.signal
                                                                                         ,$Trixel$PostOffice.moveOffsetSignal
                                                                                         ,$Trixel$PostOffice.moveMouseSignal
                                                                                         ,$Trixel$PostOffice.keyboardSignal
                                                                                         ,$Trixel$PostOffice.mouseWheelSignal
                                                                                         ,$Trixel$PostOffice.mouseButtonSignal
                                                                                         ,triggerJSInputSignal])));
   var postOfficeSignal = A3($Signal.filter,
   $Trixel$PostOffice.filterPostOfficeSignal,
   $Trixel$Types$General.None,
   workspaceSignals);
   var setTrixelColor = Elm.Native.Port.make(_elm).inboundSignal("setTrixelColor",
   "Trixel.Types.JSGlue.JSColor",
   function (v) {
      return typeof v === "object" && "red" in v && "green" in v && "blue" in v && "alpha" in v ? {_: {}
                                                                                                  ,red: typeof v.red === "number" ? v.red : _U.badPort("a number",
                                                                                                  v.red)
                                                                                                  ,green: typeof v.green === "number" ? v.green : _U.badPort("a number",
                                                                                                  v.green)
                                                                                                  ,blue: typeof v.blue === "number" ? v.blue : _U.badPort("a number",
                                                                                                  v.blue)
                                                                                                  ,alpha: typeof v.alpha === "number" ? v.alpha : _U.badPort("a number",
                                                                                                  v.alpha)} : _U.badPort("an object with fields \'red\', \'green\', \'blue\', \'alpha\'",
      v);
   });
   var setTrixelcolorSignalJS = A2($Signal.map,
   function (color) {
      return $Trixel$Types$General.SetColor($Trixel$Types$JSGlue.computeColorFromJSColor(color));
   },
   setTrixelColor);
   var startEditor = Elm.Native.Port.make(_elm).inboundSignal("startEditor",
   "Trixel.Types.Math.Vector",
   function (v) {
   ...
   var startEditorSignal = A2($Signal.map,
   function (dimensions) {
      return $Trixel$Types$General.ResizeWindow(dimensions);
   },
   startEditor);
      ...
      return function () {
         ...
         {case "_Tuple2":
            return $Trixel$Types$General.ResizeWindow({_: {}
                                                      ,x: $Basics.toFloat(_v2._0)
                                                      ,y: $Basics.toFloat(_v2._1)});}
         _U.badCase($moduleName,
         "on line 32, column 7 to 50");
      }();
   },
   $Window.dimensions);
   var updateStateSignal = A2($Signal.foldp,
   ...
   var updateStateSignalPort = Elm.Native.Port.make(_elm).outboundSignal("updateStateSignalPort",
   function (v) {
      return {cssInfo: {colorPicker: v.cssInfo.colorPicker}
             ,trixelColor: v.trixelColor};
   },
   A2($Signal.map,
   function (state) {
      return state.glueState;
   },
   updateStateSignal));
   ...
   _elm.Trixel.Main.values = {_op: _op
                             ...
                             ,setTrixelcolorSignalJS: setTrixelcolorSignalJS
                             ,triggerJSInputSignal: triggerJSInputSignal
                             ,startEditorSignal: startEditorSignal
                             ,workspaceSignals: workspaceSignals
                             ,postOfficeSignal: postOfficeSignal
                             ,updateStateSignal: updateStateSignal
                             ,main: main
...
Elm.Trixel.PostOffice.make = function (_elm) {
   ...
   function (_v14) {
      return function () {
         return PostAction($Trixel$Types$General.MoveOffset({ctor: "_Tuple2"
                                                            ,_0: {_: {}
                                                                 ,x: $Basics.negate($Basics.toFloat(_v14.x))
                                                                 ,y: $Basics.negate($Basics.toFloat(_v14.y))}
                                                            ,_1: $Trixel$Constants.workspaceOffsetMoveSpeed}));
      }();
   },
...
Elm.Trixel.Types.ColorScheme.make = function (_elm) {
   ...
   var zenburnScheme = {_: {}
                       ...
                       147,
                       1)
                       ,workbg: A4(constructColorInfo,
                       40,
                       40,
                       40,
                       1)};
   var ColorScheme = F9(function (a,
   b,
   c,
   d,
   e,
...
Elm.Trixel.Types.General.make = function (_elm) {
   ...
   var TimeInsentiveState = F2(function (a,
   b) {
      return {_: {}
             ,currentLayer: b
             ,layers: a};
   });
   var updateCachedTimeState = F2(function (newTimeState,
   state) {
      return _U.replace([["cachedTimeState"
                         ,newTimeState]
                        ,["hasUserUpdatedTimeState"
                         ,true]],
      state);
   });
   var updateUndoState = F2(function (timeState,
   state) {
   ...
   state) {
      return A2(updateUndoState,
      A2($UndoList.$new,
      newTimeState,
      state.timeState),
      state);
   });
   var applyCachedTimeState = function (state) {
      return state.hasUserUpdatedTimeState ? function () {
         var newState = A2(updateTimeState,
         state.cachedTimeState,
         state);
         return _U.replace([["hasUserUpdatedTimeState"
                            ,false]],
         newState);
      }() : state;
   };
   var getTimeState = function (state) {
      return state.cachedTimeState;
   };
   var getCurrentLayer = function (state) {
      return state.cachedTimeState.currentLayer;
   };
   var getLayers = function (state) {
      return state.cachedTimeState.layers;
   };
   ...
   var ClearState = {ctor: "ClearState"};
   var ResetOffset = {ctor: "ResetOffset"};
   ...
   var WorkState = function (a) {
      return {_: {}
             ,lastMousePosition: a};
   };
   var RenderCache = function (a) {
      return {_: {},layers: a};
   };
   var WorkSpaceActions = F3(function (a,
   b,
   c) {
      return {_: {}
             ,buttonsDown: b
             ,keysDown: a
             ,previousButtonsDown: c};
   });
   var AntiUserInputCondition = {ctor: "AntiUserInputCondition"};
   var NormalCondition = {ctor: "NormalCondition"};
   var MouseDrag = function (a) {
      return {ctor: "MouseDrag"
             ,_0: a};
   };
   ...
   var MouseDragState = F2(function (a,
   b) {
      return {_: {}
             ,difference: b
             ,position: a};
   ...
   set,
   previousSet) {
      return A2(isButtonCodeInSet,
      buttonCode,
      set) && $Basics.not(A2(isButtonCodeInSet,
      buttonCode,
      previousSet));
   });
   ...
   set,
   previousSet) {
      return A2(isKeyCodeInSet,
      keyCode,
      set) && $Basics.not(A2(isKeyCodeInSet,
      keyCode,
      previousSet));
   });
   var ButtonPressed = {ctor: "ButtonPressed"};
   var ButtonDown = {ctor: "ButtonDown"};
   var ButtonIdle = {ctor: "ButtonIdle"};
   var computeButtonState = F3(function (buttonCode,
   set,
   previousSet) {
      return A2(isButtonCodeInSet,
      buttonCode,
      set) ? ButtonDown : A2(isButtonCodeInSet,
      buttonCode,
      previousSet) ? ButtonPressed : ButtonIdle;
   });
   _elm.Trixel.Types.General.values = {_op: _op
                                      ...
                                      ,updateTimeState: updateTimeState
                                      ,applyCachedTimeState: applyCachedTimeState
                                      ,updateUndoState: updateUndoState
                                      ,updateCachedTimeState: updateCachedTimeState
...
Elm.Trixel = Elm.Trixel || {};
Elm.Trixel.Types = Elm.Trixel.Types || {};
Elm.Trixel.Types.JSGlue = Elm.Trixel.Types.JSGlue || {};
Elm.Trixel.Types.JSGlue.make = function (_elm) {
   "use strict";
   _elm.Trixel = _elm.Trixel || {};
   _elm.Trixel.Types = _elm.Trixel.Types || {};
   _elm.Trixel.Types.JSGlue = _elm.Trixel.Types.JSGlue || {};
   if (_elm.Trixel.Types.JSGlue.values)
   return _elm.Trixel.Types.JSGlue.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Trixel.Types.JSGlue",
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm);
   var JSColor = F4(function (a,
   b,
   c,
   d) {
      return {_: {}
   ...
   var emptyJSColor = {_: {}
                      ...
                      ,green: 0
                      ,red: 255};
   var computeJSColorFromColor = function (color) {
      return function () {
         var rgbaColor = $Color.toRgb(color);
         return {_: {}
                ,alpha: rgbaColor.alpha
                ,blue: $Basics.toFloat(rgbaColor.blue)
                ,green: $Basics.toFloat(rgbaColor.green)
                ,red: $Basics.toFloat(rgbaColor.red)};
      }();
   };
   var computeColorFromJSColor = function (jscolor) {
      return A4($Color.rgba,
      $Basics.round(jscolor.red),
      $Basics.round(jscolor.green),
      $Basics.round(jscolor.blue),
      jscolor.alpha);
   };
   var emptyCSSInfo = {_: {}
                      ,colorPicker: "ColorPicker"};
   var CSSInfo = function (a) {
      return {_: {}
             ,colorPicker: a};
   };
   var emptyGlueState = {_: {}
                        ,cssInfo: emptyCSSInfo
                        ,trixelColor: "rgb(255,0,0)"};
   var GlueState = F2(function (a,
   b) {
      return {_: {}
             ,cssInfo: a
             ,trixelColor: b};
   });
   _elm.Trixel.Types.JSGlue.values = {_op: _op
                                     ,GlueState: GlueState
                                     ,emptyGlueState: emptyGlueState
                                     ,CSSInfo: CSSInfo
                                     ,emptyCSSInfo: emptyCSSInfo
                                     ,computeColorFromJSColor: computeColorFromJSColor
                                     ,computeJSColorFromColor: computeJSColorFromColor
                                     ,emptyJSColor: emptyJSColor
                                     ,JSColor: JSColor};
   return _elm.Trixel.Types.JSGlue.values;
};
Elm.Trixel = Elm.Trixel || {};
...
Elm.Trixel.Types.Math.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $String = Elm.String.make(_elm);
   var computeOffsetColor = F5(function (red,
   green,
   blue,
   alpha,
   color) {
   ...
   var compareColors = F2(function (a,
   b) {
      return function () {
         var colorB = $Color.toRgb(b);
         var colorA = $Color.toRgb(a);
         return _U.eq(colorA.red,
         colorB.red) && (_U.eq(colorA.green,
         colorB.green) && (_U.eq(colorA.blue,
         colorB.blue) && _U.cmp($Basics.abs(colorA.alpha) - colorB.alpha,
         1.0e-2) < 0));
      }();
   });
   var computeAlphaBlend = F2(function (a,
   b) {
      return function () {
         var colorB = $Color.toRgb(b);
   ...
   _elm.Trixel.Types.Math.values = {_op: _op
                                   ...
                                   ,computeAlphaBlend: computeAlphaBlend
                                   ,compareColors: compareColors
                                   ,computeOffsetColor: computeOffsetColor};
   return _elm.Trixel.Types.Math.values;
};
Elm.Trixel = Elm.Trixel || {};
...
Elm.Trixel.Update.make = function (_elm) {
   ...
   state) {
      return function () {
         var glueState = state.glueState;
         return _U.replace([["trixelColor"
                            ,color]
                           ,["glueState"
                            ,_U.replace([["trixelColor"
                                         ,$Trixel$Types$Html.elmToHtmlColor(color)]],
                            glueState)]],
         state);
      }();
   });
   ...
   state) {
      ...
      $Trixel$Constants.keyCodeSpace,
      state.actions.keysDown) ? function () {
         var mousePointDifference = function () {
            var _v0 = state.mouseState;
            switch (_v0.ctor)
            {case "MouseDrag": return {_: {}
                                      ,x: point.x - _v0._0.position.x
                                      ,y: _v0._0.position.y - point.y};}
            return $Trixel$Types$Math.zeroVector;
         }();
         return _U.replace([["mouseState"
                            ,$Trixel$Types$General.MouseDrag({_: {}
         ...
         var cursorMinX = padding.x + margin.x;
         var cursorMaxX = cursorMinX + state.boxModels.workspace.width;
         var cursorMinY = padding.y + margin.y + menuOffsetY;
         var cursorMaxY = cursorMinY + state.boxModels.workspace.height;
         return $Basics.not(_U.cmp(point.x,
         cursorMinX) > -1 && (_U.cmp(point.x,
         cursorMaxX) < 1 && (_U.cmp(point.y,
         cursorMinY) > -1 && _U.cmp(point.y,
         cursorMaxY) < 1))) ? _U.replace([["mouseState"
                                          ,$Trixel$Types$General.MouseNone]
                                         ,["workState"
   ...
   var resetOffset = function (state) {
      return function () {
         var trixelInfo = state.trixelInfo;
         return _U.replace([["trixelInfo"
                            ,_U.replace([["offset"
                                         ,$Trixel$Types$Math.zeroVector]],
                            trixelInfo)]],
         state);
      }();
   };
   var updatePreviousButtonsDown = function (state) {
      return function () {
         var actions = state.actions;
         return _U.replace([["actions"
                            ,_U.replace([["previousButtonsDown"
                                         ,actions.buttonsDown]],
                            actions)]],
         state);
      }();
   };
   var applyRightButtonPressedAction = F2(function (position,
   state) {
      return updatePreviousButtonsDown($Trixel$Types$General.applyCachedTimeState(state));
   });
   var applyRightButtonDownAction = F2(function (position,
   state) {
      return function () {
         var workState = state.workState;
         ...
         return function () {
            ...
            {case "Just":
               return A2($Trixel$Types$General.updateCachedTimeState,
                 _U.replace([["layers"
   ...
   var applyLeftButtonPressedAction = F2(function (position,
   state) {
      return updatePreviousButtonsDown($Trixel$Types$General.applyCachedTimeState(state));
   });
   ...
   trixelB) {
      ...
      trixelA.position,
      trixelB.position) && A2($Trixel$Types$Math.compareColors,
      trixelA.color,
      trixelB.color);
   });
   var applyLeftButtonDownAction = F2(function (position,
   state) {
      return function () {
         var workState = state.workState;
         var timeState = $Trixel$Types$General.getTimeState(state);
         ...
         state.actions.keysDown) ? function () {
            ...
            return _U.replace([["trixelColor"
                               ,function () {
                                  ...
                                  return state.colorScheme.workbg.elm;
                               }()]],
            state);
         }() : function () {
            var maybeTrixel = A3($Trixel$Types$Layer.findTrixel,
            ...
            timeState.currentLayer,
            timeState.layers);
            var currentTrixel = function () {
               switch (maybeTrixel.ctor)
               {case "Just":
                  return maybeTrixel._0;}
               return A2($Trixel$Types$Grid.constructNewTrixel,
               {_: {},x: 2 + position.x,y: 0},
               A4($Color.rgba,0,0,0,0));
            }();
            var blendedColor = A2($Trixel$Types$Math.computeAlphaBlend,
            currentTrixel.color,
            state.trixelColor);
            ...
            currentTrixel,
            newTrixel) ? state : A2($Trixel$Types$General.updateCachedTimeState,
            _U.replace([["layers"
   ...
   var applyButtonsAction = F2(function (position,
   state) {
      return function () {
         var _v8 = A3($Trixel$Types$General.computeButtonState,
         $Trixel$Constants.buttonCodeLeft,
         state.actions.buttonsDown,
         state.actions.previousButtonsDown);
         switch (_v8.ctor)
         {case "ButtonDown":
            return A2(applyLeftButtonDownAction,
              position,
              state);
            case "ButtonPressed":
            return A2(applyLeftButtonPressedAction,
              position,
              state);}
         return function () {
            var _v9 = A3($Trixel$Types$General.computeButtonState,
            $Trixel$Constants.buttonCodeRight,
            state.actions.buttonsDown,
            state.actions.previousButtonsDown);
            switch (_v9.ctor)
            {case "ButtonDown":
               return A2(applyRightButtonDownAction,
                 position,
                 state);
               case "ButtonPressed":
               return A2(applyRightButtonPressedAction,
                 position,
                 state);}
            return state;
         }();
   ...
   var updateOffset = F3(function (offset,
   speed,
   state) {
      return function () {
         var trixelInfo = state.trixelInfo;
         ...
         x = $.x,
         y = $.y;
         var relativeSpeed = speed * trixelInfo.scale;
         var newOffsetX = x - offset.x * relativeSpeed;
         var newOffsetY = y - offset.y * relativeSpeed;
         return _U.replace([["trixelInfo"
                            ,_U.replace([["offset"
                                         ,{_: {}
                                          ,x: newOffsetX
   ...
   var applyMouseDragAction = F2(function (mouseDragState,
   state) {
      return A2($Trixel$Types$General.isKeyCodeInSet,
      $Trixel$Constants.keyCodeCtrl,
      state.actions.keysDown) ? A2(updateScale,
      state.trixelInfo.scale + 5.0e-3 * mouseDragState.difference.y,
      state) : A3(updateOffset,
      mouseDragState.difference,
      $Trixel$Constants.workspaceOffsetMouseMoveSpeed * (state.trixelInfo.scale + (1 - state.trixelInfo.scale)),
      state);
   });
   var applyBrushAction = function (state) {
      return $Trixel$Zones$WorkSpace$Grid.updateLayers(function () {
         var _v10 = state.mouseState;
         switch (_v10.ctor)
         {case "MouseDrag":
            return A2($Trixel$Types$General.isButtonCodeInSet,
              $Trixel$Constants.buttonCodeLeft,
              state.actions.buttonsDown) ? $Trixel$Zones$WorkSpace$Grid.updateGrid(A2(applyMouseDragAction,
              _v10._0,
              state)) : state;
            case "MouseHover":
            return A2(applyButtonsAction,
              _v10._0,
              state);
            case "MouseNone": return state;}
         _U.badCase($moduleName,
         "between lines 301 and 316");
      }());
   };
   ...
   state) {
      return function () {
         switch (action.ctor)
         {case "ClearState":
            return $Trixel$Zones$WorkSpace$Grid.updateGrid(clearState(state));
            case "MoveMouse":
            ...
            switch (action._0.ctor)
              {case "_Tuple2":
                 return update($Trixel$Types$General.MoveMouse(state.workState.lastMousePosition))($Trixel$Zones$WorkSpace$Grid.updateGrid(A3(updateOffset,
                   action._0._0,
                   action._0._1,
                   state)));}
              break;
            ...
            case "ResetOffset":
            return $Trixel$Zones$WorkSpace$Grid.updateGrid(resetOffset(state));
            case "ResizeWindow":
         ...
         _U.badCase($moduleName,
         "between lines 17 and 89");
      }();
   });
   var clearState = function (state) {
      return $Trixel$Types$General.resetTimeState(update($Trixel$Types$General.ResetOffset)(A2(update,
      $Trixel$Types$General.SetScale(1),
      state)));
   };
   ...
   state) {
      return function () {
         ...
         newState) : A2($Trixel$Types$General.isKeyCodeInSet,
         $Trixel$Constants.keyCodeAlt,
         keyCodeSet) ? A2(checkForCtrlAltShortcutCombinations,
         state.actions.keysDown,
   ...
   var checkForCtrlAltShortcutCombinations = F2(function (previousKeyCodeSet,
   state) {
      return A3($Trixel$Types$General.isKeyCodeJustInSet,
      $Trixel$Constants.shortcutMinus,
      state.actions.keysDown,
      previousKeyCodeSet) ? A2(update,
      $Trixel$Types$General.SetScale(state.trixelInfo.scale - 0.1),
      state) : A3($Trixel$Types$General.isKeyCodeJustInSet,
      $Trixel$Constants.shortcutEqual,
      state.actions.keysDown,
      previousKeyCodeSet) ? A2(update,
      $Trixel$Types$General.SetScale(state.trixelInfo.scale + 0.1),
      state) : state;
   ...
   state) {
      ...
      state.actions.keysDown,
      previousKeyCodeSet) ? A2(update,
      $Trixel$Types$General.ResetOffset,
      state) : state;
   });
...
Elm.Trixel.Zones.Menu.make = function (_elm) {
   ...
   $Trixel$Types$Html = Elm.Trixel.Types.Html.make(_elm),
   $Trixel$Types$Math = Elm.Trixel.Types.Math.make(_elm);
   var constructColorTool = F2(function (menuBoxModel,
   state) {
      return function () {
         ...
         4,
         $Trixel$Types$Html.BorderBox);
         var colorDivStyle = $Html$Attributes.style(A2($Basics._op["++"],
         ...
         return A2($Html.div,
         _L.fromArray([colorDivStyle
                      ,$Html$Attributes.$class(state.glueState.cssInfo.colorPicker)]),
         _L.fromArray([]));
      }();
   });
   ...
   var view = function (state) {
      return function () {
         ...
         _L.fromArray([A4(constructButton,
                      "Clear All",
                      $Trixel$Types$General.ClearState,
                      boxModel,
                      state)
                      ,A4(constructButton,
                      "Reset View",
...
Elm.Trixel.Zones.WorkSpace.make = function (_elm) {
   ...
   var viewWorkSpace = function (state) {
      return function () {
         ...
         $Basics.round(workspace.width),
         $Basics.round(workspace.height))(A2($Basics._op["++"],
   ...
   var constructMainStyle = function (state) {
      return function () {
         ...
         {ctor: "_Tuple2"
         ,_0: "background"
         ,_1: state.colorScheme.workbg.html},
         $Trixel$Types$Html.computeBoxModelCSS(workspace))));
      }();
   };
   var view = function (state) {
      return A2($Html.div,
...
Elm.Trixel.Zones.WorkSpace.Grid.make = function (_elm) {
         ...
         {case "MouseHover":
            return !_U.eq(state.condition,
              $Trixel$Types$General.NormalCondition) ? trixels : function () {
                 ...
                 triangleWidth = $._0,
                 triangleHeight = $._1;
                 var x = _v1._0.x * triangleWidth - state.trixelInfo.offset.x;
                 var y = _v1._0.y * triangleHeight - state.trixelInfo.offset.y;
                 return A2($List._op["::"],
                 A6(renderTrixel,
   ...
   var updateGrid = function (state) {
      return function () {
         var baseSize = A2($Basics.min,
         state.windowDimensions.x,
         state.windowDimensions.y) / 20;
         var trixelInfo = state.trixelInfo;
         var triangleWidth = baseSize * trixelInfo.scale;
         var triangleHeight = $Trixel$Constants.sqrt3 * baseSize * trixelInfo.scale;
         var workspace = state.boxModels.workspace;
         return updateLayers(_U.replace([["trixelInfo"
                                         ,_U.replace([["width"
                                                      ,triangleWidth]
